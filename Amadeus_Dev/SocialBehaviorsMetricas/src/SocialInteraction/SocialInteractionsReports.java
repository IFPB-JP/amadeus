...
public class SocialInteractionsReports {
	...
	public String cohesionGroup(ArrayList<String> actors, MultiMap interactions){
		...
		//System.out.println("Edges:" + numArcs);
	...
	public String reportEngagement(Map<String,Integer> indegreeValue){
		...
		String head = "**Grau de Engajamento**         "+ data + "\n"+ "\n"+ "O engajamento de um estudante corresponde ao número de interações sociais nas ferramentas de comunicação e descreve o quão ativo e central é o estudante perante o grupo. Estudantes engajados são canais importantes por onde fluem as informações.  ";
	...
	public String reportHeterogeneity(Double heterogeneity){
		...
		Double heterogeneityFormated = (double)Math.round(heterogeneity * p) / p; 
	...
	public String reportIsolation (Map<String,Double> indegreeValue){
		...
		String diagnosis = "Os estudantes "+ this.bigger(array, qtdInteractions) + " têm um maior grau de isolamento em relação a seus colegas, enquanto os estudantes "+ this.smaller(array, qtdInteractions) + " tem um menor grau de isolamento, ou seja, estão mais próximos dos seus colegas. É possível identificar dificuldade de comunicação entre estudantes causadas pela total ou parcial isolamento do grupo." ;
